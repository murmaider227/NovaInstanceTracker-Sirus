...
--Additional interface strings that were historically hardcoded in addon files.
L["luaErrorsAlreadyEnabled"] = "Lua errors are already enabled.";
L["luaErrorsEnabled"] = "Lua errors enabled.";
L["luaErrorsAlreadyDisabled"] = "Lua errors are already disabled.";
L["luaErrorsDisabled"] = "Lua errors disabled.";
L["luaErrorsArgs"] = "Valid arguments are \"on\" and \"off\".";
L["notInsideInstance"] = "You are not inside an instance to add.";
L["invalidStatsChannel"] = "Please specify a valid channel, for example: /nit stats party, /nit stats raid, or /nit stats guild.";
L["notInRaid"] = "You are not in a raid.";
L["notInParty"] = "You are not in a party.";
L["instanceDataMissing"] = "Instance data missing";
L["characterDataMissing"] = "Character data missing";
L["errorWithMessage"] = "Error: %s";
L["deleteAllTradeData"] = "Delete all trade data?";
L["Yes"] = "Yes";
L["No"] = "No";
L["tradeDataReset"] = "Trade log data has been reset.";
L["Disabled"] = "Disabled";
L["Close"] = "Close";
L["autoGettingDailyQuests"] = "Automatically accepting daily quests.";
L["lastDungeon"] = "Last Dungeon";
L["currentDungeon"] = "Current Dungeon";
L["errorDeletingCharacter"] = "Error deleting %s.";
L["tradeCooldownDataError"] = "A tradeskill cooldown data error was found for %s-%s. Cooldown data has been reset.";
L["gammaDungeon"] = "Gamma Dungeon";
L["autoGettingGammaBuff"] = "Automatically selecting %s%s buff for your current specialization (can be changed in settings).";
L["gammaBuffSelectionError"] = "Could not select the correct gamma buff. Please report this error on GitHub.";
L["tradeCopyFrame"] = "Trade Copy Frame";
...
L["Frame"] = "Frame";
L["debugTitle"] = "NIT Debug";
L["reminderTitle"] = "NIT Reminder";
L["noChannelId"] = "No channel with ID %s exists.";
L["noChannelIdOrName"] = "No channel with ID or name %s exists.";
L["slashHelpHistory"] = "Type \"/nit\" to show your instance history.";
L["slashHelpOptions"] = "Type \"/nit config\" to open settings.";
L["slashHelpChannel"] = "Type \"/nit channelname\" to post your current lockouts to a channel.";
L["Affixes"] = "Affixes";
L["colorsHeaderDesc"] = "Customize addon text colors.";
L["confirmDelete"] = "Confirm Delete";
L["Ctrl Left-Click"] = "Ctrl Left-Click";
L["Dailies Completed (Hold Shift For Alts)"] = "Dailies Completed (Hold Shift For Alts)";
L["Dailies Completed (Including Alts)"] = "Dailies Completed (Including Alts)";
L["firstAid"] = "First Aid";
L["HKs"] = "Honorable Kills";
L["ignore40ManTitle"] = "Ignore 40-player raids";
L["ignore40ManDesc"] = "Do not record 40-player raid instances.";
L["noLevelLogData"] = "No leveling history found for this character.";
L["Cooking"] = "Cooking";
L["Fishing"] = "Fishing";
L["Salt Shaker"] = "Salt Shaker";
L["Tailoring"] = "Tailoring";
L["Blackrock Caverns"] = "Blackrock Caverns";
...
L["Blackrock Foundry"] = "Blackrock Foundry";
L["Blackrock Spire"] = "Blackrock Spire";
L["Blackwing Descent"] = "Blackwing Descent";
L["Bloodmaul Slag Mines"] = "Bloodmaul Slag Mines";
...
L["Terrace of Endless Spring"] = "Terrace of Endless Spring";
L["The Arcway"] = "The Arcway";
L["The Bastion of Twilight"] = "The Bastion of Twilight";
L["The Black Morass"] = "The Black Morass";
L["The Blood Furnace"] = "The Blood Furnace";
L["The Botanica"] = "The Botanica";
...
L["Throne of Thunder"] = "Throne of Thunder";
...
L["Well of Eternity"] = "Well of Eternity";
L["World Boss (Basrikron)"] = "World Boss (Basrikron)";
L["World Boss (Bazual)"] = "World Boss (Bazual)";
L["World Boss (Liskanoth)"] = "World Boss (Liskanoth)";
L["World Boss (Strunraan)"] = "World Boss (Strunraan)";
L["Wrath Raid Boss Weekly"] = "Wrath Raid Boss Weekly";
L["Zul'Aman"] = "Zul'Aman";
